...
{
	/// <summary>
	///     Gets the tiles within the given boundaries
	/// </summary>
	public static List<Tile> FindAllSolidTiles(int minX, int maxX, int minY, int maxY) {
		List<Tile> tiles = new();
	...
	/// <returns>
	///     <see langword="true" /> if there was a <typeparamref name="T" /> instance, or <see langword="false" /> if there was no entity present OR the entity was not a <typeparamref name="T" />
	///     instance.
	/// </returns>
